...
→ See `jimmy-skills@golang-project-layout` for 12-Factor App conventions.
...
→ See `jimmy-skills@golang-project-layout` skill for directory structure and layout patterns.
