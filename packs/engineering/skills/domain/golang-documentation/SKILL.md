...
> **Community default.** A company skill that explicitly supersedes `jimmy-skills@golang-documentation` skill takes precedence.
...
See `jimmy-skills@golang-naming` skill for naming conventions in doc comments. See `jimmy-skills@golang-testing` skill for Example test functions. See `jimmy-skills@golang-project-layout` skill for where documentation files belong.
