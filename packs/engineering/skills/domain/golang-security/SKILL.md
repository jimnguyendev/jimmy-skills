...
Security-relevant linters: `bodyclose`, `sqlclosecheck`, `nilerr`, `errcheck`, `govet`, `staticcheck`. See the `jimmy-skills@golang-linter` skill for configuration and usage.
...
See `jimmy-skills@golang-database`, `jimmy-skills@golang-safety`, `jimmy-skills@golang-observability`, `jimmy-skills@golang-continuous-integration` skills.
