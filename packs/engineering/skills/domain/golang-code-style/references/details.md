...
This covers **function parameters**, not method receivers (see `jimmy-skills@golang-structs-interfaces` skill for receiver rules).
...
-> See the `jimmy-skills@golang-structs-interfaces` skill for pointer vs value **receiver** rules.
