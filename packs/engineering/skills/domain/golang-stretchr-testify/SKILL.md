...
Use `testifylint` to catch wrong argument order, assert/require misuse, and more. See `jimmy-skills@golang-linter` skill.

## Cross-References

- → See `jimmy-skills@golang-testing` skill for general test patterns, table-driven tests, and CI
- → See `jimmy-skills@golang-linter` skill for testifylint configuration
