...
→ See `jimmy-skills@golang-troubleshooting` skill (pprof.md) for on-demand debugging.
...
→ See `jimmy-skills@golang-troubleshooting` pprof.md for the full pprof CLI reference (profile types, capturing, analyzing, commands).
