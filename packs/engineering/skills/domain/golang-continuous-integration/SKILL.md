...
Create `.golangci.yml` at the root of the project. See the `jimmy-skills@golang-linter` skill for the recommended configuration.
...
See `jimmy-skills@golang-linter`, `jimmy-skills@golang-security`, `jimmy-skills@golang-testing`, `jimmy-skills@golang-dependency-management` skills.
