...
> **Community default.** A company skill that explicitly supersedes `jimmy-skills@golang-database` skill takes precedence.
...
For more injection prevention patterns, see the `jimmy-skills@golang-security` skill.
...
For context patterns in depth, see the `jimmy-skills@golang-context` skill.
...
- → See `jimmy-skills@golang-security` skill for SQL injection prevention patterns
- → See `jimmy-skills@golang-context` skill for context propagation to database operations
- → See `jimmy-skills@golang-error-handling` skill for database error wrapping patterns
- → See `jimmy-skills@golang-testing` skill for database integration test patterns
