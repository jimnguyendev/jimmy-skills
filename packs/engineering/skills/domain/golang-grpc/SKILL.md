...
- → See `jimmy-skills@golang-context` skill for deadline and cancellation patterns
- → See `jimmy-skills@golang-error-handling` skill for gRPC error to Go error mapping
- → See `jimmy-skills@golang-observability` skill for gRPC interceptors (logging, tracing, metrics)
- → See `jimmy-skills@golang-testing` skill for gRPC testing with bufconn
