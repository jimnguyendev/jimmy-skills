...
→ See `jimmy-skills@golang-concurrency` skill for detailed channel patterns and when to use worker pools instead.
...
→ See `jimmy-skills@golang-database` skill for detailed batch patterns and connection pool configuration.
