---
name: backend-go-popular-libraries
...
- → See `jimmy-skills@backend-go-dependency-management` skill for adding, auditing, and managing dependencies
- → See `jimmy-skills@backend-go-stretchr-testify` skill for testify testing details
- → See `jimmy-skills@backend-go-grpc` skill for gRPC implementation details
