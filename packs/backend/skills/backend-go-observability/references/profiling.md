...
→ See `jimmy-skills@backend-go-troubleshooting` skill (pprof.md) for on-demand debugging.
...
→ See `jimmy-skills@backend-go-troubleshooting` pprof.md for the full pprof CLI reference (profile types, capturing, analyzing, commands).
