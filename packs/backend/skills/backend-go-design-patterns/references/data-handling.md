...
When transferring large data between services (e.g., 1M rows from DB, 1M rows in HTTP response), use streaming patterns with iterators, cursors, or channel-backed pipelines to prevent OOM:
