...
This covers **function parameters**, not method receivers (see `jimmy-skills@backend-go-structs-interfaces` skill for receiver rules).
...
-> See the `jimmy-skills@backend-go-structs-interfaces` skill for pointer vs value **receiver** rules.
