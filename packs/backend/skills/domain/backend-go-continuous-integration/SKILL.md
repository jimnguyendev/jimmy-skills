---
name: backend-go-continuous-integration
...
Create `.golangci.yml` at the root of the project. See the `jimmy-skills@backend-go-linter` skill for the recommended configuration.
...
See `jimmy-skills@backend-go-linter`, `jimmy-skills@backend-go-security`, `jimmy-skills@backend-go-testing`, `jimmy-skills@backend-go-dependency-management` skills.
