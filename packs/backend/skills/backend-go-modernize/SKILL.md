...
6. **Suggest improvements contextually**:
   ...
   - If invoked explicitly via `/backend-go-modernize` or in CI, scan and suggest across the entire codebase.
