...
Run `golangci-lint` early in your debugging workflow. It catches unchecked errors, suspicious constructs, and many other issues that are easy to miss by reading code. See the `jimmy-skills@backend-go-linter` skill for configuration and usage.
