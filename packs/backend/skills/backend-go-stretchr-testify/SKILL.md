---
name: backend-go-stretchr-testify
...
Use `testifylint` to catch wrong argument order, assert/require misuse, and more. See `jimmy-skills@backend-go-linter` skill.

## Cross-References

- → See `jimmy-skills@backend-go-testing` skill for general test patterns, table-driven tests, and CI
- → See `jimmy-skills@backend-go-linter` skill for testifylint configuration
