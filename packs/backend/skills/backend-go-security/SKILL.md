...
Security-relevant linters: `bodyclose`, `sqlclosecheck`, `nilerr`, `errcheck`, `govet`, `staticcheck`. See the `jimmy-skills@backend-go-linter` skill for configuration and usage.
...
See `jimmy-skills@backend-go-database`, `jimmy-skills@backend-go-safety`, `jimmy-skills@backend-go-observability`, `jimmy-skills@backend-go-continuous-integration` skills.
