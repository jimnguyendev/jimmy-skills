...
- → See `jimmy-skills@backend-go-context` skill for deadline and cancellation patterns
- → See `jimmy-skills@backend-go-error-handling` skill for gRPC error to Go error mapping
- → See `jimmy-skills@backend-go-observability` skill for gRPC interceptors (logging, tracing, metrics)
- → See `jimmy-skills@backend-go-testing` skill for gRPC testing with bufconn
